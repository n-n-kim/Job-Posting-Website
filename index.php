      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center index-head">
            <h1><strong>HCMUT</strong> CSE Jobs Search </h1>
    ...
    <section id="candidates" class="content-header">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-sm-4 col-md-4">
            <div class="thumbnail candidate-img">
              <img src="img/interviewed2.jpeg" alt="Apply & Get Interviewed">
              <div class="caption">
          ...
          <div class="col-sm-4 col-md-4">
            <div class="thumbnail candidate-img">
              <img src="img/career2.jpg" alt="Start A Career">
              <div class="caption">
        ...
        <div class="row">
          <div class="col-sm-4 col-md-4">
            <div class="thumbnail company-img">
              <img src="img/postjob2.png" alt="Browse Jobs">
              <div class="caption">
          ...
          <div class="col-sm-4 col-md-4">
            <div class="thumbnail company-img">
              <img src="img/manage2.jpg" alt="Apply & Get Interviewed">
              <div class="caption">
